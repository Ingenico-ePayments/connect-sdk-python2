...
class AbstractParamRequestTest(unittest.TestCase):
    ...
    def test_add_parameter_string(self):
        ...
        self.assertItemsEqual(reflist, listvar)
    ...
    def test_add_parameter_long(self):
        """Tests that an AbstractParamRequest accepts a long as value"""
        name = "foo"
        value = 1234567890987654321L
        listvar = []
        reflist = [ComparableParam(name, value.__str__())]
        ParamRequest()._add_parameter(listvar, name, value)
        self.assertItemsEqual(reflist, listvar)
    ...
    def test_add_parameter_long_list(self):
        """Tests that an AbstractParamRequest accepts a list of a single long as value"""
        name = "foolist"
        value = [1337331337331337331337L]
        listvar = []
        reflist = [ComparableParam(name, value[0].__str__())]
        ParamRequest()._add_parameter(listvar, name, value)
        self.assertItemsEqual(reflist, listvar)
